// Unity Shader for Multi-Layered Planet Terrain Rendering
Shader "Custom/MultiLayeredTerrainShader"
{
    Properties
    {
        ...
        _Layer1Strength ("Layer 1 Strength", Range(0,1)) = 1.0
        _Layer2Strength ("Layer 2 Strength", Range(0,1)) = 1.0
        _Layer3Strength ("Layer 3 Strength", Range(0,1)) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed4 layer1 = tex2D(_Layer1Tex, i.uv);
                fixed4 layer2 = tex2D(_Layer2Tex, i.uv);
                fixed4 layer3 = tex2D(_Layer3Tex, i.uv);
                fixed4 bump = tex2D(_BumpMap, i.uv);
                
                // Blend layers
                fixed4 blendedColor = baseTex * _BaseColor;
                blendedColor += layer1 * _Layer1Strength;
                blendedColor += layer2 * _Layer2Strength;
                blendedColor += layer3 * _Layer3Strength;
                ...
                // Combine lighting
                float3 finalColor = blendedColor.rgb * diffuse + specular;
                ...
                fixed4 col = fixed4(finalColor, blendedColor.a);
